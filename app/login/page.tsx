    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            width: '48px', height: '48px', background: '#1e90ff',
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '8px', padding: '0.65rem 1rem', fontSize: '14px',
            color: '#0d1b2e', cursor: 'pointer', display: 'flex',
            alignItems: 'center', justifyContent: 'center', gap: '10px',
            marginBottom: '1rem', fontFamily: 'Open Sans, sans-serif',
          }}
        >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', margin: '0.75rem 0', fontSize: '12px', color: '#7a8fa8' }}>
