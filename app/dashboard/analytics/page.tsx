...
export default function AnalyticsPage() {
  ...
  const channelColors: any = {
    'Organic Search': '#00d084', 'Direct': '#1e90ff', 'Referral': '#ffa500',
    'Organic Social': '#9b59b6', 'Paid Search': '#e74c3c', 'Email': '#f39c12',
    'Unassigned': '#7a8fa8',
  }
    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          <button onClick={fetchData} className="btn btn-accent" style={{ fontSize: '12px' }} disabled={!propertyId || loading}>
