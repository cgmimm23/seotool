...
Check: Google Business Profile, Yelp, Facebook, Apple Maps, Bing Places, Yellow Pages, BBB. Score NAP consistency 0-100.`,
  ...
  const tabStyle = (t: Tab) => ({ padding: '0.5rem 1rem', fontSize: '13px', color: tab === t ? '#1e90ff' : '#7a8fa8', cursor: 'pointer', borderBottom: `2px solid ${tab === t ? '#1e90ff' : 'transparent'}`, marginBottom: '-1px', fontWeight: tab === t ? 600 : 400, background: 'none', border: 'none', borderBottom: `2px solid ${tab === t ? '#1e90ff' : 'transparent'}`, fontFamily: 'Open Sans, sans-serif' })
